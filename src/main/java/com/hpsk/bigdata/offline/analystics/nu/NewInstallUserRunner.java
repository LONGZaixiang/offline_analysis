package com.hpsk.bigdata.offline.analystics.nu;
...
import com.hpsk.bigdata.offline.analystics.dimension.key.stats.StatsDimension;
import com.hpsk.bigdata.offline.analystics.dimension.key.stats.StatsUserDimension;
import com.hpsk.bigdata.offline.analystics.dimension.value.MapWritableValue;
import com.hpsk.bigdata.offline.analystics.transformer.MySQLOutputFormat;
...
public class NewInstallUserRunner implements Tool {
	...
	public static void main(final String[] args) {
		...
		UserGroupInformation.createRemoteUser("Poche").doAs(new PrivilegedAction<Object>() {
	...
	public void setConf(Configuration conf) {
		// 本地运行
//		conf.set("fs.defaultFS", "hdfs://bigdata-training01.hpsk.com:8020");
//		conf.set("hbase.zookeeper.quorum", "bigdata-training01.hpsk.com:2181");
		//////
